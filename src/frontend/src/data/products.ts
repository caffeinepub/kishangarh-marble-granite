...
export const marbleProducts: ProductWithImages[] = [
  ...
  },
  {
    ...
    fullDescription:
      "Green Marble from Rajasthan is a visually stunning stone characterised by its deep forest-green hue offset by contrasting white and cream veining. Each slab is unique, making it a coveted choice for feature walls, statement countertops, and luxury interior accents. Its natural beauty and durability ensure lasting elegance in both residential and commercial spaces. Available at Khushi Marble, Kishangarh — MOQ: 2000 sqft (outside Rajasthan). Contact: 9829184713.",
    applications: [
      "Feature Walls",
      "Countertops",
      "Flooring",
  ...
  },
  {
    ...
    fullDescription:
      "Aspur Marble is one of the most distinctive stones sourced from the Aspur region of Rajasthan. Its vivid orange-red base is dramatically contrasted by dark green and black serpentine streaks, creating a bold visual statement unlike any other Indian marble. This stone has gained popularity in luxury hospitality design, high-end residential feature walls, and premium flooring where a truly unique aesthetic is desired. MOQ: 2000 sqft (outside Rajasthan). Available at Khushi Marble, Kishangarh. Contact: 9829184713.",
    applications: [
      "Feature Walls",
      "Flooring",
      "Bathroom Vanity",
  ...
  },
  {
    ...
    fullDescription:
      "Pink Marble is quarried from the hills of Rajasthan and is celebrated for its gentle salmon-pink tones and graceful grey-black veining. The warmth of this stone creates a welcoming, romantic atmosphere, making it a favourite for master bedrooms, luxury bathrooms, and decorative wall panels. Its fine texture takes a mirror polish beautifully, enhancing the natural colour depth. MOQ: 2000 sqft (outside Rajasthan). Available at Khushi Marble, Kishangarh. Contact: 9829184713.",
    applications: [
      "Bathroom Vanity",
      "Flooring",
      "Wall Cladding",
  ...
  },
  {
    ...
    fullDescription:
      "Torrent Marble earns its name from the spectacular river-like veining patterns that cascade across its surface in shades of brown, grey, and cream. Sourced from the quarries of Rajasthan, this marble creates a sense of movement and energy in any space it adorns. It is particularly striking in large-format floor slabs or feature walls where the continuity of the veining pattern can be fully appreciated. MOQ: 2000 sqft (outside Rajasthan). Available at Khushi Marble, Kishangarh. Contact: 9829184713.",
    applications: [
      "Flooring",
      "Wall Cladding",
      "Countertops",
  ...
  },
  {
    ...
    fullDescription:
      "Indian Marble is a broad category representing the finest natural stones quarried across the Indian subcontinent. From the white quarries of Rajasthan to the exotic stones of Gujarat, Indian marble offers unmatched variety in colour, texture, and character. Known for its durability and natural beauty, it is the backbone of India's architectural heritage and continues to be the material of choice for premium construction projects. MOQ: 2000 sqft (outside Rajasthan). Available at Khushi Marble, Kishangarh. Contact: 9829184713.",
    applications: [
      "Flooring",
      "Wall Cladding",
      "Temple Work",
  ...
  },
  {
    ...
    fullDescription:
      "Jaisalmer Yellow Marble, also known as Jaisalmer Stone, radiates the warmth of the Thar Desert with its golden-yellow tones and fine granular texture. Quarried from the limestone-rich region of Jaisalmer, Rajasthan, this stone has been used in the historic forts and havelis of Rajasthan for centuries. It is highly weather-resistant and particularly suited for exterior applications, garden landscaping, and warm-toned interiors. MOQ: 2000 sqft (outside Rajasthan). Available at Khushi Marble, Kishangarh. Contact: 9829184713.",
    applications: [
      "Exterior Facade",
      "Flooring",
      "Garden Landscape",
  ...
  },
  {
    ...
    fullDescription:
      "Rainforest Green Marble is a spectacular stone sourced from Rajasthan that draws immediate attention with its rich green base interlaced with golden-yellow veining. The dramatic contrast between the deep green and warm gold tones creates an organic, nature-inspired aesthetic that transforms any surface into a work of art. It is particularly favoured for feature walls, luxury bathroom designs, and statement countertops. MOQ: 2000 sqft (outside Rajasthan). Available at Khushi Marble, Kishangarh. Contact: 9829184713.",
    applications: [
      "Flooring",
      "Wall Cladding",
      "Feature Walls",
  ...
  },
  {
    ...
    fullDescription:
      "Katni Marble, sourced from the mineral-rich Katni district of Madhya Pradesh, is one of the most widely used marbles in Indian residential and religious construction. Its warm creamy-beige base with natural brown and golden veining provides an earthy sophistication that is both timeless and accessible. The stone is workable, durable, and takes a good polish, making it ideal for large-scale flooring, wall panelling, and intricate temple carvings. MOQ: 2000 sqft (outside Rajasthan). Available at Khushi Marble, Kishangarh. Contact: 9829184713.",
    applications: [
      "Flooring",
      "Wall Panels",
      "Temple Work",
  ...
  },
  {
    ...
    fullDescription:
      "Udaipur Marble is quarried near the historic lake city of Udaipur, Rajasthan, and reflects the refined aesthetic of the region's royal architectural legacy. Its white-grey surface with elegant flowing veins conveys a sense of tranquillity and classical beauty. It has been used extensively in temples, sculptures, and heritage renovations across Rajasthan. Suitable for both indoor luxury applications and heritage-inspired architectural projects. MOQ: 2000 sqft (outside Rajasthan). Available at Khushi Marble, Kishangarh. Contact: 9829184713.",
    applications: [
      "Flooring",
      "Staircase",
      "Wall Cladding",
...
export const graniteProducts: ProductWithImages[] = [
  {
    ...
    fullDescription:
      "Kashmir Gold Granite from Rajasthan is celebrated for its warm golden-yellow base punctuated by dark brown, black, and cream mineral flecks that create a rich, inviting texture. One of the most popular granites for kitchen countertops, it combines aesthetic warmth with the exceptional hardness granite is known for. Its resistance to scratches, heat, and staining makes it the ideal workhorse stone for premium kitchens and exterior cladding. Available at Khushi Marble, Kishangarh. Contact: 9829184713.",
    applications: [
      "Kitchen Countertops",
      "Exterior Cladding",
      "Flooring",
  ...
  },
  {
    ...
    fullDescription:
      "Absolute Black Granite from Tamil Nadu is the definitive choice for contemporary design. Its deep, consistent jet-black colour with no visible crystal patterns creates the sleekest possible aesthetic for kitchen countertops, bathroom floors, and architectural details. It polishes to a near-mirror finish, amplifying the drama of its colour. A go-to stone for minimalist, industrial, and modern luxury design schemes. Available at Khushi Marble, Kishangarh. Contact: 9829184713.",
    applications: [
      "Kitchen Countertops",
      "Bathroom Flooring",
      "Wall Cladding",
  ...
  },
  {
    ...
    fullDescription:
      "Markino Black Granite sourced from South India is a premium dark stone known for its deep black surface and fine uniform texture. It polishes to an exceptional mirror finish, making it the perfect choice for modern kitchen countertops, sleek bathroom designs, and high-traffic commercial floors. Its hardness rating ensures superior resistance to scratches and impacts, ensuring long-term beauty and performance. MOQ: 2000 sqft (outside Rajasthan). Available at Khushi Marble, Kishangarh. Contact: 9829184713.",
    applications: [
      "Kitchen Countertops",
      "Bathroom Vanity",
      "Commercial Spaces",
  ...
  },
  {
    ...
    fullDescription:
      "Juprana White Granite from Rajasthan is a contemporary favourite, offering a predominantly white surface with fine grey and black mineral speckles that add subtle texture and depth. This stone bridges the visual gap between white marble and traditional granite, offering the cleanliness of white marble with the superior hardness and durability of granite. It is an excellent choice for kitchen countertops, bathroom vanities, and modern flooring projects. MOQ: 2000 sqft (outside Rajasthan). Available at Khushi Marble, Kishangarh. Contact: 9829184713.",
    applications: [
      "Kitchen Countertops",
      "Flooring",
      "Wall Cladding",
  ...
  },
  {
    ...
    fullDescription:
      "Ruby Red Granite from Rajasthan is among the most visually striking granites available, featuring a deep ruby-red body suffused with sparkling white and silver crystal formations. This stone radiates energy and luxury, making it a premier choice for monument construction, premium commercial flooring, and exterior cladding on landmark buildings. Its extreme hardness ensures longevity even in the most demanding exterior environments. MOQ: 2000 sqft (outside Rajasthan). Available at Khushi Marble, Kishangarh. Contact: 9829184713.",
    applications: [
      "Monuments",
      "Flooring",
      "Exterior Cladding",
...
export const exoticProducts: ProductWithImages[] = [
  ...
  },
  {
    ...
    fullDescription:
      "Honey Onyx from Iran is one of the most ethereally beautiful natural stones available. Its warm amber and honey tones carry a natural translucency that, when backlit, creates a glowing, luminescent effect unlike any other stone. MOQ: 2000 sqft (outside Rajasthan). Contact: 9829184713.",
    applications: [
  ...
  },
  {
    ...
    fullDescription:
      "Emerald Pearl Granite from Norway is quarried from one of the world's most exclusive stone deposits. Its deep, lustrous green base is illuminated by thousands of shimmering silver, grey, and gold mineral crystals. MOQ: 2000 sqft (outside Rajasthan). Contact: 9829184713.",
    applications: [
      "Feature Walls",
      "Kitchen Countertops",
      "Luxury Flooring",
  ...
  },
  {
    ...
    fullDescription:
      "Blue Agate from Brazil is a semi-precious stone of extraordinary beauty, featuring vivid electric blue and white concentric banding patterns. Its natural translucency makes it ideal for backlit installations. MOQ: 2000 sqft (outside Rajasthan). Contact: 9829184713.",
    applications: [
      "Backlit Feature Walls",
      "Luxury Panels",
      "Bar Counters",
  ...
  },
  {
    ...
    fullDescription:
      "Calacatta Gold Marble from Carrara, Italy is the most prestigious white marble in existence. Its brilliant white background adorned with dramatic gold and warm brown veining creates an iconic luxury aesthetic. MOQ: 2000 sqft (outside Rajasthan). Contact: 9829184713.",
    applications: [
      "Bathroom Vanity",
      "Kitchen Countertops",
      "Feature Walls",
  ...
  },
  {
    ...
    fullDescription:
      "Red Dragon Marble, imported from China, is one of the most striking exotic stones available. Its deep crimson-red body is traversed by dramatic white and silver veining. MOQ: 2000 sqft (outside Rajasthan). Contact: 9829184713.",
    applications: [
      "Feature Walls",
      "Luxury Flooring",
      "Reception Areas",
  ...
  },
  {
    ...
    fullDescription:
      "Labradorite from Madagascar is perhaps the most magical of all exotic stones. Its dark base is suffused with a spectacular iridescent optical phenomenon that produces shifting blue, green, gold, and violet colour displays as light changes angle. MOQ: 2000 sqft (outside Rajasthan). Contact: 9829184713.",
    applications: [
      "Feature Walls",
  ...
  },
  {
    ...
    fullDescription:
      "Fusion Quartzite from Brazil is the most vivid and colourful exotic stone available. Its surface is a riot of swirling purples, pinks, oranges, blues, and creams — no two slabs are alike. MOQ: 2000 sqft (outside Rajasthan). Contact: 9829184713.",
    applications: [
      "Feature Walls",
      "Kitchen Countertops",
      "Bathroom Vanity",
  ...
  },
  {
    ...
    fullDescription:
      "Fantasy Brown Quartzite combines the flowing organic aesthetic of marble with the superior hardness of quartzite. Its flowing brown, chocolate, cream, and white patterns create a dream-like quality. MOQ: 2000 sqft (outside Rajasthan). Contact: 9829184713.",
    applications: [
      "Kitchen Countertops",
      "Bathroom Vanity",
      "Feature Walls",
  ...
  },
  {
    ...
    fullDescription:
      "Portoro Black Marble from the island of Portovenere in Italy is among the most sought-after luxury marbles globally. Its intensely deep black background is dramatically lit by bold, bright gold veining. MOQ: 2000 sqft (outside Rajasthan). Contact: 9829184713.",
    applications: [
      "Feature Walls",
      "Bathroom Vanity",
      "Countertops",
  ...
  },
  {
    ...
    fullDescription:
      "Verde Guatemala Marble, imported from Central America, is prized for its deep tropical green base contrasted by elegant white and cream veining. MOQ: 2000 sqft (outside Rajasthan). Contact: 9829184713.",
    applications: [
      "Feature Walls",
      "Bathroom Vanity",
      "Flooring",
  ...
  },
  {
    ...
    fullDescription:
      "Tiger Skin Quartzite from Brazil captivates with its bold amber-orange base crossed with dramatic black mineral bands that evoke the markings of a tiger. MOQ: 2000 sqft (outside Rajasthan). Contact: 9829184713.",
    applications: [
      "Feature Walls",
      "Statement Countertops",
      "Luxury Flooring",
  ...
  },
  {
    ...
    fullDescription:
      "Super White Quartzite from Brazil delivers the clean, bright white aesthetic of Carrara marble combined with the superior hardness and stain-resistance of quartzite. MOQ: 2000 sqft (outside Rajasthan). Contact: 9829184713.",
    applications: [
      "Kitchen Countertops",
      "Bathroom Vanity",
      "Flooring",
  ...
  },
  {
    ...
    fullDescription:
      "Calacatta Viola is one of the rarest marbles quarried in Italy, distinguished by its white background traversed by dramatic purple and violet veining patterns. MOQ: 2000 sqft (outside Rajasthan). Contact: 9829184713.",
    applications: [
      "Feature Walls",
      "Bathroom Vanity",
      "Luxury Flooring",
  ...
  },
  {
    ...
    fullDescription:
      "Multicolor Red Quartzite from the quarries of Brazil is a high-energy stone featuring vivid reds, oranges, pinks, and cream in flowing, organic swirling patterns. MOQ: 2000 sqft (outside Rajasthan). Contact: 9829184713.",
    applications: [
      "Feature Walls",
      "Kitchen Countertops",
      "Bathroom Vanity",
